...
_POSITIVE: dict[str, float] = {
    "rally": 1.0, "surge": 1.0, "breakthrough": 1.2, "beat": 0.8,
    "soar": 1.0, "gain": 0.6, "growth": 0.6, "upgrade": 0.7,
    "bullish": 1.0, "outperform": 0.8, "buy": 0.7, "strong": 0.5,
    "record": 0.7, "high": 0.4, "recovery": 0.7, "optimism": 0.7,
    "profit": 0.7, "dividend": 0.5, "deal": 0.5,
}
_NEGATIVE: dict[str, float] = {
    "crash": -1.2, "plunge": -1.0, "miss": -0.8, "warning": -0.7,
    "drop": -0.6, "fall": -0.6, "bearish": -1.0, "downgrade": -0.8,
    "sell": -0.7, "loss": -0.6, "weak": -0.5, "low": -0.4,
    "recession": -1.0, "fear": -0.7, "panic": -1.0, "collapse": -1.2,
    "fraud": -1.0, "lawsuit": -0.7, "default": -1.0,
}
